...
Use Emberjs with this guide[http://nandovieira.com/setting-up-emberjs-with-rails-ember-cli-edition] and 
Use emblem (similar slim), need to install ember-cli-emblem[https://github.com/Vestorly/ember-cli-emblem]
